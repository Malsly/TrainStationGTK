...
public partial class MainWindow : Gtk.Window
{
    ...
    public MainWindow() : base(Gtk.WindowType.Toplevel)
    {
        ...
        if (Environment.GetEnvironmentVariable("WithSerialize") == "False") 
        {
            Deb.Print("Start without serialization");

            List<Dictionary<string, DateTime>> RoutesAndDates = ser.DeserializeListRoutesAndDates("RoutesAndDates.json");
            List<Dictionary<string, int>> RoutesAndPrices = ser.DeserializeListRoutesAndPrices("RoutesAndPrices.json");
